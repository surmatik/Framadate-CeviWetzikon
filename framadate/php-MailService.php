...
class MailService {
    ...
    public function send(string $to, string $subject, string $body, ?string $msgKey = null): void
    {
        if ($this->smtp_allowed === true && $this->canSendMsg($msgKey)) {
            ...
            // Bodies
            $body .= '<br><br><hr><br><p style="font-size:8pt;">Finden Sie uns auch online:</p><p style="font-size:8pt;"><a href="https://www.instagram.com/cevi.wetzikon/">Instagram</a> | <a href="https://www.facebook.com/ceviwetzikon/">Facebook</a> | <a href="https://cevi-wetzikon.ch/">Webseite</a></p><br><img src="https://i.postimg.cc/QCYDCPNp/Cevi-Wetikon-farb.png" height="106" alt="Logo">';
            $mail->isHTML(true);
